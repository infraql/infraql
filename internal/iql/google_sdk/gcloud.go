...
const (
	...
	gcloudInstallInfo     string = `Visit https://cloud.google.com/sdk to download the SDK or alternatively use serviceaccount mode, see https://help.infraql.io/AUTH.html for more information`
